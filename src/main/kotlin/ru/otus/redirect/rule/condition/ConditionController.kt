...
import ru.otus.redirect.exception.NoConditionImplementationException
import java.io.File
...
class ConditionController {
    ...
    fun upload(@RequestParam("jar") jarFile: MultipartFile) {
        ...
        val condition = serviceLoader.findFirst().orElseThrow { NoConditionImplementationException() }
